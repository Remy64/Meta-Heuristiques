...
public class Main {
    ...
    static {
        ...
        solvers.put("greedy_SPT", new GreedySolver(GreedySolver.Priority.SPT));
        solvers.put("greedy_LRPT", new GreedySolver(GreedySolver.Priority.LRPT));
        solvers.put("greedy_EST_SPT", new GreedySolver(GreedySolver.Priority.EST_SPT));
        solvers.put("greedy_EST_LRPT", new GreedySolver(GreedySolver.Priority.EST_LRPT));
        ...
        for(String instanceName : instances) {
            ...
            for(int job = 0; job < instance.numJobs; job++) {
            	for(int task = 0; task < instance.numTasks; task++)
            		sommeDuree += instance.duration(job, task);
            }
            System.out.println("duree totale instance ft06 : "+sommeDuree);
            */
